...
const steps = [
  ...
  { num: "04", title: "Гарантия", text: "Выдаём гарантийный талон на все виды выполненных работ" },
];

const advantages = [
  { title: "Опыт 14 лет", text: "Более 15 000 отремонтированных устройств", icon: "⭐" },
  { title: "Гарантия до 12 мес.", text: "На все виды работ и запчасти", icon: "🛡️" },
  { title: "Выезд на дом", text: "Бесплатный выезд мастера в черте города", icon: "🚗" },
  { title: "Быстро", text: "Большинство ремонтов выполняется в день обращения", icon: "⚡" },
];

export default async function HomePage() {
  const { s, services } = await getData();
